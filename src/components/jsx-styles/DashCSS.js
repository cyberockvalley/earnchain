...
export default function DashCSS({isGlobal}) {
    ...
    .container {
        ...
        --color-darkblue: #F0B90B;
        --color-darkblue1: #184a64;
        --color-lightblue: #F0B90B;
        --color-pink: #ff6cc5;
        --color-asset-up: rgb(14, 203, 129);
        --color-asset-down: rgb(246, 70, 93);
        --color-darkpink: #EC61B5;
        --color-purple: #ff6cc5;
        --color-lilac: rgb(14, 203, 129);
        --color-red: #d36d71;
        --color-green: #8BC24A;
        --color-black: #333;
    ...
    body {/*
        background: url(/resources/img/bgwithtiger.jpg) no-repeat center !important;*/
        font: 300 15px/28px"Montserrat", sans-serif !important;
        color: #fff !important;
    ...
    .matrix-icon_cart__big {
        ...
        width: 50px;
        height: 50px;
        background: url(/resources/img/cartbig.svg) no-repeat
    }
    ...
    .matrix-icon_cart__small:after {
        ...
        width: 23px;
        height: 23px;
        background: url(/resources/img/cartsmall.svg) no-repeat
    }
    ...
    .matrix-icon_sync {
        background: url(/resources/img/reinvest.svg) no-repeat
    }
    
    .matrix-icon_users {
        background: url(/resources/img/partners.svg) no-repeat
    }
    
    .matrix-icon_lost {
        background: url(/resources/img/lost.svg) no-repeat
    }
