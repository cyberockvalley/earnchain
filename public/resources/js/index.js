    ...
    if (document.querySelector('.faqq')) {
        ! function(i) {
            ...
            i(".accordion-heading").on("click", function() {
                o = i(this).parents(".accordion"), n = o.find(".accordion-content"), o.hasClass("active") ? (o.removeClass("active"), n.slideUp()) : (o.addClass("active"), n.stop(!0, !0).slideDown(), o.siblings(".active").removeClass("active").children(".accordion-content").stop(!0, !0).slideUp());
            })
        }(jQuery);
    }
